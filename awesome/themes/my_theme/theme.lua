...
local colors                 = require("themes.my_theme.colors")
...
theme.bg_normal     = colors.colors.color0
theme.bg_focus      = colors.colors.color13
theme.bg_urgent     = colors.colors.color8
theme.bg_minimize   = colors.colors.color14
theme.transparent   = "#00000000"
theme.bg_systray    = colors.bg_normal
theme.bg_textclock  = colors.bg_systray
theme.bg_layoutbox  = colors.bg_systray

theme.fg_normal     = colors.colors.foreground
theme.fg_focus      = colors.colors.color0
theme.fg_urgent     = colors.colors.color0
theme.fg_minimize   = colors.colors.color0

theme.useless_gap   = dpi(0)
theme.border_width  = dpi(0)
theme.border_normal = colors.colors.color0
theme.border_focus  = colors.colors.color13
theme.border_marked = colors.colors.color8

theme.taglist_fg_focus                          = colors.colors.color0
theme.taglist_fg_occupied                       = colors.colors.color0
theme.taglist_fg_urgent                         = colors.colors.color0
theme.taglist_fg_empty                          = theme.fg_normal
theme.taglist_bg_focus                          = colors.colors.color2
theme.taglist_bg_occupied                       = colors.colors.color1
theme.taglist_bg_urgent                         = colors.colors.color3
theme.taglist_bg_empty                          = theme.bg_normal

theme.topbar_border                             = colors.colors.color7
